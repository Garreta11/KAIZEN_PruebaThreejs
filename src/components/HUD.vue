<template>
  <div class="hud-container">
    <!-- Icono para abrir el HUD, se oculta cuando el HUD está visible -->
    ...
    <!-- HUD con controles, se oculta cuando hudVisible es false -->
    <div class="hud" :class="{ hidden: !hudVisible }">
      <!-- Icono para cerrar el HUD -->
...
// Emisión de eventos para actualizar valores en el padre
...
// Variables locales para el color, inicializadas con los props
...
// Variables locales para la velocidad de rotación, con valor por defecto 0.01 si no se recibe
...
// Vigilar cambios en colores locales para emitirlos al componente padre
...
// Vigilar cambios en velocidades locales para emitirlos al componente padre
...
// Estado para mostrar u ocultar el HUD
